...
<link rel="stylesheet" href="css/userRegisterAgree.css">
<script src="https://moden939.gabia.io/js/jquery-1.8.3.min.js"></script>
</head>
<body>
<header>
	<div class="wrap">
...
<main>
	<div class="wrap_ag">
        <div id="register_agree">
            <h3 class="register-title">약관 동의</h3>
		
		    <form name="fregister" id="fregister" action="userRegister.jsp" onsubmit="return fregister_submit(this);" method="POST" autocomplete="off">
                <div class="checkbox-wrap" id="fregister_chkall">
                    <input type="checkbox" name="chk_all" value="1" id="chk_all">
                    <label for="chk_all">회원가입 약관에 모두 동의합니다</label>
                </div>
			
			    <section class="checkbox-wrap" id="fregister_term">
                    <div>
                        <input type="checkbox" name="agree" value="1" id="agree11">
                        <label for="agree11">이용약관 동의<span>(필수)</span></label>
                    </div>
			        
			        <textarea readonly=""class="ta_agree">제1조(목적) 이 약관은 업체 회사(전자상거래 사업자)가 운영하는 업체 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
			...
			제24조(재판권 및 준거법)
			  ...
			  ② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
			    ...
			    <section class="checkbox-wrap" id="fregister_term">
                    <fieldset class="fregister_agree2">
                        <input type="checkbox" name="agree2" value="1" id="agree21">
                        <label for="agree21">개인정보 수집 및 이용 동의<span>(필수)</span></label>
                    </fieldset>
			
					<textarea readonly="" class="ta_agree">개인정보처리방침
			...
			2) 시행일자 : 2018년 05월 01일 </textarea>
			    ...
			    <div class="btn-wrap">
					<a href="userLogin.jsp" class="btn_cancel">CANCEL</a>
			        <input type="submit" class="btn_submit" value="회원가입" id="btn_submit1">
			    </div>
		    </form>
		</div>
	</div>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const normalJoinButton = document.getElementById("btn_submit1");

        normalJoinButton.addEventListener("click", function() {
